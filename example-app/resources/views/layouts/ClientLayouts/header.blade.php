<header id="header" class="fixed-top">
    <div class="container d-flex justify-content-between align-items-center" style="direction: rtl;">
  
      <h1 class="logo m-0">
        <a href="{{ route('user') }}" style="font-weight: bold;">یوتاب پارس</a>
      </h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>راه حلی بهتر برای کسب و کار ها</h1>
          <h2>ما یک تیم برنامه نویسی جهت توسعه کسب و کارها هستیم</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto">شروع همکاری</a>
