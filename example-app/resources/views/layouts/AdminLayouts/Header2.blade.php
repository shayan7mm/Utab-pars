...
<head>
    ...
    <link href="{{ asset('AdminPannel/SecondTheme/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('AdminPannel/SecondTheme/assets/css/plugins.css') }}" rel="stylesheet" type="text/css" />

    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="{{ asset('AdminPannel/SecondTheme/plugins/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('AdminPannel/SecondTheme/assets/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <script src="{{ asset('AdminPannel/SecondTheme/assets/js/libs/jquery-3.1.1.min.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/bootstrap/js/popper.min.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/plugins/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/assets/js/app.js') }}"></script>
    ...
    <script src="{{ asset('AdminPannel/SecondTheme/plugins/apex/apexcharts.min.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/assets/js/dashboard/dash_2.js') }}"></script>
    <script src="{{ asset('AdminPannel/SecondTheme/assets/js/custom.js') }}"></script>  
