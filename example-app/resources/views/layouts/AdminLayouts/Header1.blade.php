    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        <nav id="compactSidebar">
            <ul class="menu-categories">
                ...
                <li>
                    <a href="{{ route('AddTeamMember') }}"  class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                ...
                <li>
                    <a href="{{ route('AllMessages') }}" class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                ...
                <li>
                    <a href="{{ route('AllServices') }}" class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                ...
                <li>
                    <a href="{{ route('AdminBlog') }}"  class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                ...
                <li>
                    <a href="{{ route('PricingPlan') }}" class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
                ...
                <li>
                    <a href="{{ route('Projects') }}"  class="menu-toggle">
                        <div class="base-menu">
                            <div class="base-icons">
